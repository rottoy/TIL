...
9. Data Sharding([Data Sharding 이란?](https://github.com/rottoy/TIL/blob/main/courses/GROKKING%20THE%20SYSTEM%20DESIGN/data-sharding.md))
    1. 유저ID를 기반으로한 파티셔닝
